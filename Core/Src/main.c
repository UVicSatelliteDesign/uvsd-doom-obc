...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, PARA_BRN_1_Pin|GPIO_PIN_12, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : PARA_BRN_1_Pin PA12 */
  GPIO_InitStruct.Pin = PARA_BRN_1_Pin|GPIO_PIN_12;
